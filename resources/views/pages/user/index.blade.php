                                ...
                                @forelse ($items as $index => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{ Storage::disk('public')->exists($item->photo) ? Storage::url($item->photo) : asset('assets/img/image_not_available.png') }}"
                                                 alt="{{ $item->name }} img" class="img-fluid rounded mt-1 mb-1" height="100px" width="100px" />
                                        </td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->email }}</td>
                                        <td>
